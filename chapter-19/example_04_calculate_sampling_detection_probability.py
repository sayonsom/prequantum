...
def miss_probability_without_replacement(sifted_bits: int, erroneous_bits: int,
                                         revealed_bits: int) -> float:
...
def main() -> None:
    ...
    for revealed_bits in (1, 5, 10, 20, 40, 80):
        miss = miss_probability_without_replacement(sifted_bits, erroneous_bits,
                                                    revealed_bits)
        detection = 1 - miss
